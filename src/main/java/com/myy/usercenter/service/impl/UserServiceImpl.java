...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public User getCurrentUser(HttpServletRequest request) {
        ...
        User curLoginUser = (User) request.getSession().getAttribute(USER_LOGIN_STATE);//toDo
    ...
    /**更新(修改)用户信息
     * toDo  第2步验证失败，怎么内部运行了，外面也运行了？？？？？     还有3！=3什么鬼？(来个类型强转)
     */
    @Override
    public int updateUser(User user, User loginUser) {
        ...
        //2、校验权限  ->管理员可以更新任意信息   ->用户只能更新自己的信息
        if (!isAdmin(loginUser) && userId != loginUser.getId()){
            //System.out.println("userId:"+userId+"-"+"loginUser.getId():"+loginUser.getId());
            //System.out.println(userId==loginUser.getId());//fasle ??
            //非管理员&&且还要修改别人的信息
        ...
        // 3. 触发更新
        return this.baseMapper.updateById(user);//toDo更新全部信息
    ...
    public List<User> matchUsers(long num, User loginUser) {
        ...
        for (int i = 0; i < userList.size(); i++) {
            ...
            // 计算分数
            long distance = com.myy.friends.utils.AlgorithmUtils.minDistance(tagList, userTagList);
